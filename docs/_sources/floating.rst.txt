...
- **Shelve Metabolite**: Temporarily removes metabolites from the graph. These metabolites can be added back to the map using the *Shelved Metabolites* subsection of the floating menu described below. Metabolites can also be shelved by uploading a list of regular expressions under the *Load Metabolites to Shelve* option in the *Upload/Download* tab in the top menu. For more details please refer to the *Secondary Metabolites* section of the documentation. Shortcut key **s**.
